...
static const char *const yytname[] =
{
  ...
  "T_THEN", "T_ELSE", "T_WHILE", "T_TRUE", "T_FALSE", "T_INTCONST",
  "T_IDENT", "T_UNKNOWN", "$accept", "P", "V", "$@1", "N", "C", "S", "A",
  "F", "@2", "@3", "$@4", "W", "@5", "@6", "E", "L", "B", "R", YY_NULLPTR
};
#endif
...
{
      16,     1,    36,    32,    21,   -60,    14,    33,    -4,    35,
     -60,    39,    40,    11,    26,    38,   -60,   -60,   -60,    12,
      32,     1,     0,   -60,     9,     9,   -60,    -4,     9,     9,
     -60,   -60,   -60,   -60,   -60,    41,    -1,    42,    44,     0,
      22,    43,   -60,    25,    43,    24,   -60,   -60,   -60,   -60,
     -60,   -60,     9,   -60,   -60,   -60,   -60,   -60,    43,    30,
      48,   -60,    -4,    -4,   -60,    37,   -60,    -4,   -60
};
...
static const yytype_uint8 yydefact[] =
{
       ...
       7,     3,     0,    19,     0,     0,     2,     9,     0,     0,
       6,     5,    29,    30,    25,    23,     0,    24,     0,     0,
       0,    13,     8,     0,    14,     0,    31,    32,    33,    34,
      35,    36,     0,    15,    20,    26,    27,    22,    28,     0,
       0,    16,     0,     0,    21,     0,    17,     0,    18
};

  /* YYPGOTO[NTERM-NUM].  */
static const yytype_int8 yypgoto[] =
{
     -60,   -60,    45,   -60,    47,    29,   -59,   -60,   -60,   -60,
     -60,   -60,   -60,   -60,   -60,   -23,    -8,    18,   -60
};
...
{
      19,    40,    41,    64,    65,    43,    44,    45,    68,    46,
      47,    48,    49,    50,    51,    11,    24,    28,    12,    19,
      25,    29,    13,    32,    33,    34,    35,     3,    55,    58,
      45,    56,     1,    45,    34,    35,     5,     6,     8,     9,
      10,    20,    22,    23,    26,    27,    24,    28,    53,    57,
      61,    45,    62,     0,    19,    19,    42,    54,    66,    19,
       0,     0,     0,     0,     0,     0,    31,    30
};

static const yytype_int8 yycheck[] =
{
       8,    24,    25,    62,    63,    28,    29,     8,    67,    10,
      11,    12,    13,    14,    15,    19,     5,     5,    22,    27,
       9,     9,    26,    23,    24,    25,    26,    26,     6,    52,
       8,     6,    16,     8,    25,    26,     0,     5,    17,    25,
       7,     6,     3,     3,    18,     7,     5,     5,     4,    25,
      20,     8,     4,    -1,    62,    63,    27,    39,    21,    67,
      -1,    -1,    -1,    -1,    -1,    -1,    21,    20
};
...
{
       0,    16,    29,    26,    30,     0,     5,    32,    17,    25,
       7,    19,    22,    26,    33,    34,    35,    36,    40,    44,
       6,    31,     3,     3,     5,     9,    18,     7,     5,     9,
      32,    30,    23,    24,    25,    26,    43,    44,    45,    41,
      43,    43,    33,    43,    43,     8,    10,    11,    12,    13,
      14,    15,    46,     4,    45,     6,     6,    25,    43,    37,
      42,    20,     4,    38,    34,    34,    21,    39,    34
};

  /* YYR1[YYN] -- Symbol number of symbol that rule YYN derives.  */
static const yytype_uint8 yyr1[] =
{
       0,    28,    29,    30,    31,    30,    32,    32,    33,    33,
      34,    34,    34,    35,    35,    37,    38,    39,    36,    41,
      42,    40,    43,    43,    43,    43,    44,    44,    45,    45,
...
#line 202 "hw6.y" /* yacc.c:1646  */
	...
	if (DEBUG) printTypeInfo((yyvsp[-2].ch), s);
	Instruction x;
	sprintf(x.result, "%c", (yyvsp[-2].ch));
	strcpy(x.arg1, (yyvsp[0].instrx).result);
	strcpy(x.arg2, "");
	x.opCode = OP_NA; 
	addInstruction(x);
	}
...
#line 214 "hw6.y" /* yacc.c:1646  */
	...
	prRule("A", "L = E");
	Instruction x;
	strcpy(x.result, (yyvsp[-2].instrx).arrayBaseName);
	strcpy(x.arg1, (yyvsp[-2].instrx).arg1);
	strcpy(x.arg2, (yyvsp[0].instrx).result);
...
#line 225 "hw6.y" /* yacc.c:1646  */
	...
	strcpy((yyval.cstring), buffer);    // where to go if false
	strcpy(x.arg1, (yyvsp[-1].instrx).result);
	strcpy(x.arg2, "");
...
#line 242 "hw6.y" /* yacc.c:1646  */
	...
	x1.opCode = OP_GOTO;
	addInstruction(x1);
	strcpy(x2.result, (yyvsp[-4].cstring));
	strcpy(x2.arg1, "");
	strcpy(x2.arg2, "");
	x2.opCode = OP_LABEL;
	addInstruction(x2);
...
#line 256 "hw6.y" /* yacc.c:1646  */
	...
	Instruction x;
	strcpy(x.result, (yyvsp[-4].cstring));  // L.done
	strcpy(x.arg1, "");
	strcpy(x.arg2, "");
	x.opCode = OP_LABEL;
	addInstruction(x);
...
#line 291 "hw6.y" /* yacc.c:1646  */
	...
	prRule("S", "while ( B ) S");
	Instruction x1, x2;
  	strcpy(x1.result, (yyvsp[-4].cstring));
  	strcpy(x1.arg1, "");
  	strcpy(x1.arg2, "");
  	x1.opCode = OP_GOTO;
  	addInstruction(x1);
  	strcpy(x2.result, (yyvsp[-2].cstring));
  	strcpy(x2.arg1, "");
  	strcpy(x2.arg2, "");
  	x2.opCode = OP_LABEL;
  	addInstruction(x2);
...
#line 307 "hw6.y" /* yacc.c:1646  */
	...
	prRule("E", "E + INTCONST");
  	...
  	strcpy((yyval.instrx).result, buffer);
  	strcpy(x.result, buffer);
  	strcpy((yyval.instrx).arg1, (yyvsp[-2].instrx).result);
  	strcpy(x.arg1, (yyvsp[-2].instrx).result);
  	sprintf(buffer, "%d", (yyvsp[0].num));
  	strcpy((yyval.instrx).arg2, buffer);
  	strcpy(x.arg2, buffer);
  	(yyval.instrx).opCode = OP_PLUS; 
  	x.opCode = OP_PLUS; 
  	addInstruction(x);
	}
...
#line 324 "hw6.y" /* yacc.c:1646  */
	...
	if (DEBUG) printTypeInfo((yyvsp[0].ch), s);
    	sprintf((yyval.instrx).result, "%c", (yyvsp[0].ch));
    	strcpy((yyval.instrx).arg1, "");
...
#line 334 "hw6.y" /* yacc.c:1646  */
	...
	prRule("E", "L");
  	...
  	strcpy((yyval.instrx).result, buffer);
    	strcpy(x.result, buffer);
    	strcpy((yyval.instrx).arg1, (yyvsp[0].instrx).arrayBaseName);
    	strcpy(x.arg1, (yyvsp[0].instrx).arrayBaseName);
    	strcpy((yyval.instrx).arg2, (yyvsp[0].instrx).arg2); 
    	strcpy(x.arg2, (yyvsp[0].instrx).arg2);
    	(yyval.instrx).opCode = OP_ASSIGN_INDEXED_RHS;
...
#line 359 "hw6.y" /* yacc.c:1646  */
	...
	if (DEBUG) printTypeInfo((yyvsp[-3].ch), s);
    	Cstring buffer;
    	Instruction x;
   	sprintf(buffer, "%c", (yyvsp[-3].ch));
    	strcpy((yyval.instrx).arrayBaseName, buffer);
  	(yyval.instrx).arraySubscriptForType = 1;
  	(yyval.instrx).opCode = OP_NA;
      
  	sprintf(buffer, "t%d", generateNewTemp());
  	strcpy(x.result, buffer);
  	strcpy((yyval.instrx).arg1, buffer);
  	strcpy((yyval.instrx).arg2, buffer);
  	strcpy((yyval.instrx).result, buffer);
  	strcpy(x.arg1, (yyvsp[-1].instrx).result);
	...
	prRule("L", "L [ E ]");
  	Instruction x1, x2;
    	Cstring buffer;
     	...
     	strcpy((yyval.instrx).result, buffer);
     	strcpy((yyval.instrx).arg1, buffer);
     	strcpy(x2.arg1, (yyvsp[-3].instrx).result);
     	x2.opCode = OP_PLUS;
     	strcpy(x1.arg1, (yyvsp[-1].instrx).result);
     	x1.opCode = OP_STAR;
     	strcpy((yyval.instrx).arg2, buffer);
     	(yyval.instrx).opCode = OP_NA;
     	strcpy((yyval.instrx).arrayBaseName, (yyvsp[-3].instrx).arrayBaseName);
     	SubscriptInfo s =
       findEntryInSymbolTable((yyvsp[-3].instrx).arrayBaseName[0]);
	if (DEBUG) printTypeInfo((yyvsp[-3].instrx).arrayBaseName[0], s);
     	(yyval.instrx).arraySubscriptForType = (yyvsp[-3].instrx).arraySubscriptForType + 1;
     	sprintf(buffer, "%d", 
             computeArrayElementWidth(s,
					          (yyval.instrx).arraySubscriptForType));
